...
build("FN",{
 ...
 "action":"SELL","tone":"negative",
 "rationale":"0.25 x $144 (Bear) + 0.45 x $245 (Base) + 0.15 x $338 (Bull) + 0.20 x $268 (EV/EBITDA cross-check) = $251. A well-run optical assembler, but ~6x sales for a thin-margin contract manufacturer prices a flawless AI-optical decade; intrinsic value sits ~57% below spot.",
 ...
 "recommendation_table":[
   {"action":"Direction","detail":"SELL / avoid on valuation. Excellent operator, but ~6x sales for an assembler is unsupportable; intrinsic ~$251."},
   {"action":"12m target","detail":"$251 (25% x $144 + 45% x $245 + 15% x $338 + 20% x $268 cross-check)."},
