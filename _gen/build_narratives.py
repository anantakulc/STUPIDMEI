...
build("COHR",{
 ...
 "rationale":"0.25 x $51 (Bear) + 0.45 x $121 (Base) + 0.15 x $184 (Bull) + 0.20 x $140 (EV/EBITDA cross-check) = $123. Intrinsic DCF lands ~65% below a share that has roughly 5x'd off its 52-week low. A real AI-optical franchise, priced for a decade of flawless 1.6T execution.",
 ...
 "snapshot":snap([("Last close","$355.94"),("52-week range","$76.88 to $440.00"),
   ...
   ("Beta (est)","1.45"),("Intrinsic vs price","-65%")]),
 "thesis":[
   ...
   "The problem is price. At roughly 12x sales for a components maker whose datacom margins are perpetually reset each generation, an intrinsic DCF lands near $123 against a $356 stock. The franchise is real; the multiple prices a flawless decade."],
 ...
 "recommendation_table":[
   {"action":"Direction","detail":"SELL / avoid. Excellent AI-optical franchise, but intrinsic DCF (~$123) sits ~65% below the $356 price."},
   {"action":"12m target","detail":"$123 (25% x $51 + 45% x $121 + 15% x $184 + 20% x $140 cross-check)."},
